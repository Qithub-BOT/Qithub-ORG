...
[bot, OSS, mastodon, qiitadon, Qithub]
...
- [Qithub の仕様](#Qithubの仕様)
   ...
   - [要件](#要件)
    ...
    - [動作仕様](#動作仕様)
        ...
        - [トゥートに ReToot リンクを埋める](#トゥートにReTootリンクを埋める)
    - [プラグイン仕様](#プラグイン仕様)
        - [範囲](#範囲)
...
###### <a name="fork先からのマージ手順"></a> fork 先からのマージ手順 ([scripts #60](https://github.com/Qithub-BOT/scripts/issues/60))
...
## <a name="記事について"></a> 記事について

### <a name="スパム記事の場合"></a> スパム記事の場合 ([scripts #56](https://github.com/Qithub-BOT/scripts/scripts/56))

特に対策しません。

理由：新着記事の通知が Qithub の本筋であって、Qiita の記事のクオリティに言及するものではないからです。

### <a name="記事のライセンス"></a>記事のライセンス ([items #63](https://github.com/Qithub-BOT/items/issues/63))
...
### <a name="ライセンス"></a>ライセンス ([items #63](https://github.com/Qithub-BOT/scripts/isssues/31))
...
### <a name="Qithub用語"></a> Qithub 用語 ([scripts #78](https://github.com/Qithub-BOT/scripts/issues/78))
...
##### <a name="トゥートに ReToot リンクを埋める"></a> トゥートに ReToot リンクを埋める
