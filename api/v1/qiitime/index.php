...
EOD;
    ...
    // -------------------------------------------------------------------------
    $status =<<<EOD
自分用のニュースやメモ・トゥートで LTL や FTL を汚したくない。でも後日ハッシュタグで検索対象にしたい。そんなトゥートがあれば、このトゥートに返信してね。

P.S. このトゥートの ID （Status ID）は https://qithub.tk/api/v1/qiitime/ から JSON 形式で取得できるよ。内容もインスタンスも問わないけど、ウチ（Qiitadon のインスタンス）をピンポンダッシュするような明らかな迷惑トゥートはしないでね。
🗓 #${date_tag_Ym} #${date_tag_Ymd} #${date_tag_YmdH}
EOD;
